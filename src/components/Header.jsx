...
const Header = () => {
    ...
    return (
        <header className={clsx("fixed top-0 left-0 z-50 w-full py-10 transition-all", hasScrolled && "py-2 bg-black-100 backdrop-blur-[8px]")}>
